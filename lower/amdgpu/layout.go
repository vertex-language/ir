...
// the two extended floats, which is also what hipcc uses for device code,
// since a struct has to have the same layout on both sides of a kernel
// launch. The walk itself is the one every backend carries.
